...
public class NotificationCollectorMonitorService extends Service {
    ...
    private void ensureCollectorRunning() {
        ComponentName collectorComponent = new ComponentName(this, /*NotificationListenerService Inheritance*/ NotificationServiceList.class);
    ...
    private void toggleNotificationListenerService() {
        ...
        ComponentName thisComponent = new ComponentName(this, /*getClass()*/ NotificationServiceList.class);
